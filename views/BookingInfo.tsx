...
const BookingInfo: React.FC<BookingInfoProps> = ({ onBack }) => {
  ...
  if (submitted) {
    return (
      <div className="container mx-auto px-6 max-w-2xl py-20 text-center animate-fade transition-colors">
  ...
  return (
    <div className="container mx-auto px-6 max-w-5xl py-12 animate-fade transition-colors">
      <button 
        onClick={onBack}
      ...
      <div className="flex flex-col lg:flex-row gap-12">
        ...
        <div className="flex-grow">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button 
              type="submit"
              className="w-full py-5 bg-sky-600 text-white font-black text-lg rounded-3xl btn-shadow hover:bg-sky-700 transition-all shadow-xl mt-4"
            >
        ...
        <div className="w-full lg:w-[350px] shrink-0">
          <div className="sticky top-32 space-y-6">
            <div className="bg-slate-900 dark:bg-slate-900/80 p-8 rounded-[2.5rem] text-white shadow-2xl relative overflow-hidden transition-colors">
            ...
            <div className="bg-sky-50 dark:bg-sky-950/30 p-8 rounded-[2.5rem] border border-sky-100 dark:border-sky-900/50 space-y-6 transition-colors">
