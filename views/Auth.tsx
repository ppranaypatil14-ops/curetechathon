...
const Auth: React.FC<AuthProps> = ({ mode, onBack, onToggleMode }) => {
        ...
        <div className="hidden md:flex md:w-1/2 bg-slate-900 dark:bg-slate-950 p-12 text-white flex-col justify-between relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-white/60 text-lg font-medium leading-relaxed max-w-sm">
              {mode === 'login'
                ? "Manage your appointments, health records and consult with specialists with ease."
                : "Create an account to start your personalized health journey with our world-class medical team."}
            </p>
          </div>
          ...
          <div className="relative z-10 bg-white/5 border border-white/10 p-6 rounded-3xl backdrop-blur-md">
            ...
            <p className="text-sm text-white/40 font-medium">
              We use advanced encryption to ensure your medical data is safe, secure and accessible only to you.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-10 md:p-16 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                ...
                {mode === 'login' && (
                  <button type="button" className="text-[10px] font-bold text-sky-600 dark:text-sky-400 uppercase hover:underline">Forgot?</button>
                )}
              </div>
              <div className="relative">
            ...
            >
              {mode === 'login' ? 'Continue to Portal' : 'Create My Account'}
          ...
          <div className="mt-10">
            <div className="relative flex items-center justify-center mb-8">
              ...
              <span className="absolute bg-white dark:bg-slate-900 px-4 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Or social link</span>
            </div>
